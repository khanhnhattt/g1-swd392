...
public class FansMessage extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String email = request.getParameter("email");
                String typeContact = request.getParameter("contact");
		...
		String htmlTextMessage = "" + "<html>" + "<body>"
				...
				+ "<br><br/> Type of contact: " + typeContact + "," + "<br/><br/> Comment: " + "<span style='color:grey;'>" + comments + "</span>"
				+ "<br/><br/>We are glad that fans are choosing us! <br/><br/>Thanks & Regards<br/><br/>Auto Generated Mail"
				+ "</body>" + "</html>";
		String message = MailMessage.sendMessage("ducdepde159@gmail.com", "Fans Message | " + name + " | " + email,
				htmlTextMessage);
