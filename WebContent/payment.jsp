        ...
        <div class="info-wrapper">
            ...
            <div class="products-in-cart col-md-9">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td><%=product.getProdId()%>
                        </td>
                        <td><%=product.getProdName()%>
                        </td>
                        <td><%=product.getProdCategory()%>
                        </td>
                        <td><%=product.getProdPrice()%>
                        </td>
                        <td><%=prodQuantity%>
                        </td>
                        <td><%=product.getProdPrice() * prodQuantity%>
                        </td>
                    </tr>
                ...
                <div class="order-summary">
                    <p>Tổng số sản phẩm: <%=totQuantity%>
                    </p>
                    <p>Phí vận chuyển: 0</p>
                    <p>Tổng cộng: <%=totAmount%>
                    </p>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                    <tr>
                        <td><%=request.getParameter("pid")%>
                        </td>
                        <td><%=request.getParameter("pName")%>
                        </td>
                        <td><%=request.getParameter("pType")%>
                        </td>
                        <td><%=request.getParameter("amount")%>
                        </td>
                        <td>1</td>
                        <td><%=request.getParameter("amount")%>
                        </td>
                ...
                <div class="order-summary">
                    ...
                    <p>Phí vận chuyển: 0</p>
                    <p>Tổng cộng: <%=request.getParameter("amount")%>
                    </p>
